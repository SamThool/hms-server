...
// New Schema for Salary and Wages
const salaryAndWagesSchema = new mongoose.Schema({
  employeeId: { type: mongoose.Types.ObjectId, ref: 'Consultant', required: true },
  name: { type: String },
  designation: { type: String },
  incomeDetails: {
    basicSalary: { type: Number },
    incomeComponents: { type: Map, of: Number },
  ...
  deductionDetails: {
    ...
    totalEmployerContributions: { type: Number },
  },
});
...
const consultantSchema = new mongoose.Schema(
  {
    ...
    salaryAndWages: salaryAndWagesSchema, // Add the new schema here
  },
  {
    timestamps: true,
  }
